...
```{r}
matCG<-getReadMatrix(bamFile=bamFile,genomeFile=genomeFile,bedFile=bedFileCG,region=regionGR)
...
allSampleRelCoordMats<-getRelativeCoordMats(matList=matTable, regionGRs=tssWin,
